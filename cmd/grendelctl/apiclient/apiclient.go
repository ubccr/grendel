...
// API is the client the grendelctl commands talk to the server with, built by Register during PersistentPreRunE
var API *client.Client

// Register adds the endpoint flag and builds the client during PersistentPreRunE. Only grendelctl calls it, grendel serves the api rather than calling it and cannot reach the socket it has not created yet
func Register() {
