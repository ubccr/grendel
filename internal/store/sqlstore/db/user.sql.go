...
values (?1, ?2, ?3)
returning id, role, username, password_hash, enabled, created_at, updated_at
`
...
select id, role, username, password_hash, enabled, created_at, updated_at from user where username = ?1
`
...
select id, role, username, password_hash, enabled, created_at, updated_at from user
`
