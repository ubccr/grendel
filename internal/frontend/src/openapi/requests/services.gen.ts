 ...
 */
export const getV1ConfigGet = <ThrowOnError extends boolean = false>(options?: Options<GetV1ConfigGetData, ThrowOnError>) => { return (options?.client ?? client).get<GetV1ConfigGetResponse, GetV1ConfigGetError, ThrowOnError>({
    ...options,
    url: '/v1/config/get'
}); };
 ...
 */
export const getV1ConfigGetFile = <ThrowOnError extends boolean = false>(options?: Options<GetV1ConfigGetFileData, ThrowOnError>) => { return (options?.client ?? client).get<GetV1ConfigGetFileResponse, GetV1ConfigGetFileError, ThrowOnError>({
    ...options,
    url: '/v1/config/get/file'
}); };
 ...
 */
export const patchV1ConfigSet = <ThrowOnError extends boolean = false>(options: Options<PatchV1ConfigSetData, ThrowOnError>) => { return (options?.client ?? client).patch<PatchV1ConfigSetResponse, PatchV1ConfigSetError, ThrowOnError>({
    ...options,
    url: '/v1/config/set'
}); };
