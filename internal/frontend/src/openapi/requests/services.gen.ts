 ...
 */
export const deleteV1BmcJobs = <ThrowOnError extends boolean = false>(options: Options<DeleteV1BmcJobsData, ThrowOnError>) => { return (options?.client ?? client).delete<DeleteV1BmcJobsResponse, DeleteV1BmcJobsError, ThrowOnError>({
    ...options,
    url: '/v1/bmc/jobs'
}); };
 ...
 */
export const postV1BmcUpgradeDellInstallfromrepo = <ThrowOnError extends boolean = false>(options: Options<PostV1BmcUpgradeDellInstallfromrepoData, ThrowOnError>) => { return (options?.client ?? client).post<PostV1BmcUpgradeDellInstallfromrepoResponse, PostV1BmcUpgradeDellInstallfromrepoError, ThrowOnError>({
    ...options,
 ...
 */
export const getV1BmcUpgradeDellRepo = <ThrowOnError extends boolean = false>(options?: Options<GetV1BmcUpgradeDellRepoData, ThrowOnError>) => { return (options?.client ?? client).get<GetV1BmcUpgradeDellRepoResponse, GetV1BmcUpgradeDellRepoError, ThrowOnError>({
    ...options,
