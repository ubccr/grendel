                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        ...
                        <br /> Set the scanner to include an enter keystroke or
                        Carriage Return as a suffix, focus the textbox and scan.
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                </div>
            ...
            <Table>
              ...
              <TableBody>
                {query.map((query, i) => (
                  <TableRow
                    key={i}
                    className={`${i == 0 && !!query.node.name && "bg-green-50 hover:bg-green-100 dark:bg-green-800 hover:dark:bg-green-700"} ${i == 0 && !query.node.name && "bg-red-50 hover:bg-red-100 dark:bg-red-800 hover:dark:bg-red-700"}`}
                  >
