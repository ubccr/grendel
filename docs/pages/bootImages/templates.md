...
In order to use Autoinstall, we will need a template in `/var/lib/grendel/templates/ubuntu-autoinstall.tmpl`. An example file can be found [here](https://github.com/ubccr/grendel/blob/main/internal/provision/templates/ubuntu-autoinstall.tmpl), modify as needed.
...
In order to use Kickstart, we will need a template in `/var/lib/grendel/templates/rocky-kickstart.tmpl`. An example file can be found [here](https://github.com/ubccr/grendel/blob/main/internal/provision/templates/kickstart.tmpl), modify as needed.
