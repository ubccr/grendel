...
/*
HostDelete Delete hosts by name or nodeset
...
/*
HostTag Tag hosts by name or nodeset
...
func (a *HostApiService) HostTag(ctx _context.Context, nodeSet string, tags string) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/host/tag/{nodeSet}"
	localVarPath = strings.Replace(localVarPath, "{"+"nodeSet"+"}", _neturl.QueryEscape(parameterToString(nodeSet, "")) , -1)
...
func (a *HostApiService) HostTags(ctx _context.Context, tags string) (model.HostList, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/host/tags/{tags}"
	localVarPath = strings.Replace(localVarPath, "{"+"tags"+"}", _neturl.QueryEscape(parameterToString(tags, "")) , -1)
...
/*
HostUntag Untag hosts name or nodeset
...
func (a *HostApiService) HostUntag(ctx _context.Context, nodeSet string, tags string) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/host/untag/{nodeSet}"
	localVarPath = strings.Replace(localVarPath, "{"+"nodeSet"+"}", _neturl.QueryEscape(parameterToString(nodeSet, "")) , -1)
